...
<div className="flex lg:flex-row sm:flex-col w-3/5 self-center border-[1px] border-blue-gray-800 mx-auto my-20 shadow-lg rounded-lg">
  <div className="w-1/2 flex flex-row px-4 gap-2 self-center  ">
  <FontAwesomeIcon icon={faMagnifyingGlass}  className='text-blue-gray-600 self-center'/>
  <input type='text' className='w-full font-body-plex py-4 border-r-[1px] border-blue-gray-700' placeholder='Search for projects, opportunities, datasets'/> </div>
  <div className="w-1/2 flex gap-2 flex-row px-4 self-center  ">
